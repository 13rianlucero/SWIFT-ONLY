...
import GameplayKit
import SpriteKit
// Set up the blackjack game scene
class BlackJackScene: SKScene {
    ...
    // MARK: Set up chips in the bottom of the screen
    ...
    func add(betAmount: CoinValue) {
        // Error handle, make sure you can't bet more than your wallet.
    ...
    // Check then preform action, BlackJack logic.
    func dealBtnAxn() {
        instruction.text = ""
        ten.isHidden = true
